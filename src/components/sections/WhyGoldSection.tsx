...
export function WhyGoldSection({ dict }: { dict: Dictionary }) {
  const { whyGold } = dict;
  return (
    <section id="why-gold" className="scroll-mt-20 px-6 py-24 md:px-10 md:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <ul className="mt-16 grid gap-12 border-t border-z-line pt-12 md:grid-cols-3">
          {whyGold.points.map((p) => (
            <li key={p.title}>
